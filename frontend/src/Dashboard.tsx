 ...
 */
function PartTotalPriceDashboardItem({
  context
}: {
  ...
  const pluginName: string = 'PartTotalPrice';
...
//  component
export function renderPartTotalPriceDashboardItem(
  context: InvenTreePluginContext
) {
  checkPluginVersion(context);
  return <PartTotalPriceDashboardItem context={context} />;
}
